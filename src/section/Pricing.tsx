                    ...
                    {pricingData.map((item, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={twMerge(
                                    "p-10 rounded-3xl border max-w-xs w-full",
                            ...
                            >
                                ...
                                <p
                                    className={twMerge(
                                        "mt-4 text-sm",
                                        inverse ? "text-black/70" : "text-white/70"
                                    )}
                                >
                                    {item.describe}
                                </p>

                                <button className="w-full mt-[30px] px-4 py-2 rounded-lg font-medium transition-colors bg-gradient-to-t from-[#201F30] to-[#464553] hover:opacity-90">
                                    {item.buttonText}
                                </button>
